...
<Container class="py-12 sm:py-20">
  <div class="mx-auto max-w-3xl">
    <h1 class="heading-page text-slate-900 dark:text-white mb-2">Terms of Service</h1>
    ...
    <div class="prose prose-slate dark:prose-invert max-w-none space-y-8">
      ...
      <section>
        <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. User Accounts</h2>
        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
          You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You must provide accurate information when creating an account and keep it up to date.
        </p>
      </section>
      ...
      <section>
        <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-3">6. Prohibited Use</h2>
        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">You agree not to:</p>
        <ul class="list-disc list-inside text-slate-600 dark:text-slate-400 space-y-1 mt-2">
          <li>Use the Service for any unlawful purpose</li>
          <li>Submit false or misleading trail reports or reviews</li>
      ...
      <section>
        <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-3">7. Termination</h2>
        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <section>
        <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-3">9. Changes to Terms</h2>
        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
          We may update these terms from time to time. Continued use of the Service after changes constitutes acceptance of the revised terms. We will notify users of material changes via the Service.
        </p>
      </section>
