<script lang="ts">
  ...
  let { id, title, icon, delay = 0, children }: Props = $props();
  ...
  const iconPaths: Record<string, string> = {
    ...
    parking: 'M8 21V7a4 4 0 014-4h0a4 4 0 014 4v14M8 10h8',
...
<section
  {id}
  class="mt-12 first:mt-0 animate-fade-in-up scroll-mt-24"
